class RiskProfilersController < InheritedResources::Base
  ...
  def update
    update!(:notice => "You have answered #{resource.responses.length} out of #{resource.quiz.questions}.Your responses have been saved successfully. Answer all questions to view your score") { financial_planner_url }
  end
end
