    ...
    Navcp.all.each do |navcp|
      ...
      if @scheme
        @scheme.update_attributes( :ticker_name           => navcp.ticker,
                                   ...
                                   :prev1_week_per        => navcp.prev1_week_per,
                                   :prev1_month_amount    => navcp.prev1_month_amount,
                                   :prev1_month_per       => navcp.prev1_month_per,
                                   :prev3_months_amount   => navcp.prev3_months_amount,
                                   :prev3_months_per      => navcp.prev3_months_per,
                                   :prev6_months_amount   => navcp.prev6_months_amount,
                                   :prev6_months_per      => navcp.prev6_months_per,
                                   :prev9_months_amount   => navcp.prev9_months_amount,
                                   :prev9_months_per      => navcp.prev9_months_per,
                                   :prev_year_amount      => navcp.prev_year_amount,
                                   :prev_year_per         => navcp.prev_year_per,
                                   :prev2_year_amount     => navcp.prev2_year_amount,
                                   :prev2_year_per        => navcp.prev2_year_per,
                                   :prev2_year_comp_per   => navcp.prev2_year_comp_per,
                                   :prev3_year_amount     => navcp.prev3_year_amount,
                                   :prev3_year_per        => navcp.prev3_year_per,
                                   :prev3_year_comp_per   => navcp.prev3_year_comp_per,
                                   :list_date             => navcp.list_date,
                                   :list_amount           => navcp.list_amount,
                                   :list_per              => navcp.list_per,
                                   :rank                  => navcp.rank )
        navcp.destroy
      end
    end
