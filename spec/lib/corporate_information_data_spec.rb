...
describe CorporateInformationData, :mongoid, :vcr do
  ...
  it "should have a MFObjective record" do
    ...
    record = MfObjective.where( securitycode: "14056988.002066" ).first
  ...
  it "should have a NavCategoryDetail record" do
    ...
    NavCategoryDetail.exists?( conditions: { scheme_class_code: "2395",
                                             scheme_class_description: "Debt - Floaters",
                                             no_of_schemes: 44,
                                             one_month_return: "0.7153",
                                             three_year_return: "16.0677" } ).should be_true
  end

  it "should have a Navcp record" do
    subject.parse_and_update("NAVCP.xml")
    Navcp.exists?( conditions: { security_code: "14050050.002067",
  ...
  it "should have a NavMaster record" do
    ...
    NavMaster.exists?( conditions: { security_code: "14056938.002066",
                                     scheme_code: "14056938",
                                     mapping_code: "116597",
