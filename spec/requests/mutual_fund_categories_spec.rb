...
describe "MutualFundCategories", :mongoid do
  ...
  let (:scheme) { create :scheme, :scheme_class_description => navcd.scheme_class_description, :rank => 10, :nav_amount => 10,
                                  :minimum_investment_amount => 20, :scheme_class_code => navcd.scheme_class_code,
  ...
  it "should scheme categories show page" do
    ...
    click_link scheme.scheme_class_description

    expected_table = [
                         [ scheme.scheme_name, "10", "10.00", "20.00", "1.00", "2.00", "2.00", "3.00", "3.00", "2.00", "3.00"]
                      ]
