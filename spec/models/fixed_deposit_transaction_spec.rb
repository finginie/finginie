...
describe FixedDepositTransaction do
  ...
  it "should get action and amount" do
    ...
    fixed_deposit_transaction.action.should eq :buy
    fixed_deposit_transaction.amount.should eq 20

    fixed_deposit_transaction.price = -20
    fixed_deposit_transaction.action.should eq :sell
    fixed_deposit_transaction.amount.should eq 20
  end

  it "should set action and amount" do
    fixed_deposit_transaction.action = :buy
    fixed_deposit_transaction.amount = 20
    fixed_deposit_transaction.price.should eq 20

    fixed_deposit_transaction.action = :sell
    fixed_deposit_transaction.amount = 10
    fixed_deposit_transaction.price.should eq -10
  end
  ...
  it "should give correct porfit or loss for redeemed deposit" do
    ...
    fixed_deposit_transaction_2 = create :fixed_deposit_transaction, :date => 1.months.ago.to_date, :price => -100000, :fixed_deposit => fixed_deposit_2, :portfolio => portfolio
